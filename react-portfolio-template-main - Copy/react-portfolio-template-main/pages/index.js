              ...
              <div className="mt-10 space-y-8">
                ...
                {data.resume.expertise?.length > 0 && (
                  <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6">
                    <h3 className="text-lg font-semibold text-slate-100">Expertise</h3>
                    <div className="mt-4 flex flex-wrap gap-3">
                      {data.resume.expertise.map((skill) => (
                        <button
                          key={skill}
                          type="button"
                          className="cursor-default rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-slate-100 transition hover:bg-white/10"
                        >
                          {skill}
                        </button>
                      ))}
